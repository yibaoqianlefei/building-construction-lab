...
function NodeCard({ node, index }) {
  return (
    ...
    >
      ...
      >
        <div className="w-full h-20 bg-surface-soft rounded-xl mb-4 flex items-center justify-center text-3xl">
          🧱
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {courseModules.map((mod, i) => {
          ...
          return (
            <motion.div
              key={mod.id}
              className="bg-surface-soft border border-hairline rounded-xl p-8
            ...
            >
              ...
              <h3 className="text-xl font-normal text-muted-soft mt-5 tracking-tight">
                {mod.title}
              </h3>
              <p className="text-sm text-muted-soft mt-2 leading-relaxed">
                {mod.description}
              </p>
  ...
  return (
    ...
    >
      ...
      <div className="mb-8 mt-6">
        <h1 className="text-2xl font-normal font-serif text-ink tracking-tight">
          {module.title}
        </h1>
