...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <header className="pt-16 pb-12 md:pt-24 md:pb-16 px-6 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800 tracking-tight font-[family-name:var(--font-serif,inherit)]">
          建筑构造交互系统
        </h1>
        <p className="mt-3 text-gray-400 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
          交互式探索建筑构造的空间逻辑
        </p>
      </header>
