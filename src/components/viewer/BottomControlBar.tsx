    ...
    >
      ...
      {explodeAxis != null && (
        <>
          ...
          >
            ...
            <span className="absolute -bottom-0.5 left-1/2 -translate-x-1/2 text-[10px] text-muted-soft hidden sm:block">E</span>
          </button>

          {/* mobile minus */}
          <button
            onClick={stepDown}
            className="sm:hidden w-6 h-6 rounded-lg flex items-center justify-center shrink-0
              text-muted-soft hover:text-primary hover:bg-hairline transition-all duration-200"
            title="减少"
          >
      ...
      {onLabelsToggle && (
        <button
          ...
          className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center
            transition-all duration-300 relative shrink-0
            ${showLabels ? "bg-hairline" : ""}`}
          title="标签 (L)"
        >
          <Tags
            size={16}
            className={`sm:size-[18px] transition-colors duration-300 ${
              showLabels ? "text-primary" : "text-muted-soft"
            }`}
            strokeWidth={1.5}
          />
          <span className="absolute -bottom-0.5 left-1/2 -translate-x-1/2 text-[10px] text-muted-soft hidden sm:block">L</span>
        </button>
      )}
          ...
          <div ref={moreRef} className="relative shrink-0">
            <button
              ...
              className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center
                ...
                ${moreActive ? "bg-hairline text-primary" : "text-muted-soft hover:text-primary hover:bg-hairline"}`}
              title="更多工具"
            >
              <MoreHorizontal size={16} className="sm:size-[18px]" strokeWidth={1.5} />
              {moreActive && (
                <span className="absolute top-0.5 right-0.5 w-1.5 h-1.5 rounded-full bg-hairline0" />
              )}
            </button>
              ...
              >
                {onScreenshotToggle && (
                  <button
                    ...
                    className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center
                      ...
                      ${screenshotActive ? "bg-hairline text-primary" : "text-muted-soft hover:text-primary hover:bg-hairline"}`}
                    title="截图 (Ctrl+S)"
                  >
                    <svg
                ...
                {onSyncZoomToggle && (
                  <button
                    ...
                    className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center
                      transition-all duration-200
                      ${syncZoom ? "bg-hairline text-primary" : "text-muted-soft hover:text-primary hover:bg-hairline"}`}
                ...
                {onOrthographicToggle && (
                  <button
                    ...
                    className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center
                      transition-all duration-200
                      ${isOrthographic ? "bg-hairline text-primary" : "text-muted-soft hover:text-primary hover:bg-hairline"}`}
